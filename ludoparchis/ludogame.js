...
// ▼▼▼ REEMPLAZA LA FUNCIÓN 'renderRoomsOverview' COMPLETA CON ESTO ▼▼▼
...
function renderRoomsOverview(rooms = []) {
    ...
    rooms.forEach(roomData => {
        try {
            ...
            // Lógica de visualización del tipo de juego (sin cambios)
            let gameTypeHTML = '';
            if (gameType === 'parchis') {
            ...
            // Renderizar el HTML (ahora con el stateText correcto)
            div.innerHTML = `
                <div class="info">
            ...
            // ... (lógica de conversión de créditos, sin cambios) ...
            ...
            btnEnter.onclick = () => {
                ...
                console.log(`VALIDANDO UNIÓN: Créditos=${userCreditsNow} ${userCurrencyNow} vs Requerido=${requiredInUserCurrency.toFixed(2)} ${userCurrencyNow}`); 
                if (hasEnough) {
