...
const CACHE_NAME = 'mutijuego-v1.12.67'; // Actualizado: Permitir salir del navegador/PWA sin eliminar inmediatamente - esperar 2 minutos de inactividad (igual que Ludo)
const urlsToCache = [
  '/',
  '/index.html',
  '/select.html',
